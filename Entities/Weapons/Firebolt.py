...
class Firebolt(RangedWeapon):
    def __init__(self, weapon_x, weapon_y, direction):
        ...
        self.bullet = Projectile(self.weapon_x, self.weapon_y, self.speed, self.direction, self.damage, pygame.image.load("graphics/objects/entities/entity16_fireball.png").convert(), self.range)
